...
public interface DeviceMapper {
	...
	* @throws
	...
	/**
	* @Description: 查找所有数据库中处于开启黑名单功能状态的设备
	* @param @return
	* @return List<Device> 
	* @throws
	 */
	@Select("SELECT \"ID\" as id, \"RESOURCE_ID\" as resourceId, \"IS_BLACKLIST_ON\" as status, \"cn\", \"device_model\" as deviceModel, \"device_type\" as deviceType, \"ip\", \"port\", \"INDEXCODE\" as indexcode,\"password_strength\" as pwdStrength FROM \"TB_DEVICE\" WHERE \"IS_BLACKLIST_ON\"='on' AND \"cn\" LIKE CONCAT('%',#{cn}, '%')")
	List<Device> findAllOn(@Param("cn") String cn);
